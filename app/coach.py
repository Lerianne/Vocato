...
def build_system_prompt() -> str:
    ...
    if experience:
        ...
        # what she has actually done — it OUTRANKS retrieved snippets and the
        ...
        parts.append(
            ...
            "This is the human-verified record of what she has ACTUALLY done. "
            "Trust it over anything retrieved or synthesized. If a retrieved cover "
            "letter or job posting names a company NOT here, she applied — she did "
            f"not work there.\n{experience}")
    if history:
        parts.append(
            "\n## Career history (AUTO-SYNTHESIZED — may contain errors)\n"
            "Generated by a small model from her documents; useful for themes and "
...
# she APPLIED FOR / WANTED — never proof she actually held that role.
PROVENANCE = {
    "resume": "✅ ACTUAL EXPERIENCE — from her résumé; things she has really done",
    "cover-letter": "📨 A JOB APPLICATION SHE SENT — she applied for this role/company; "
                    "this is NOT proof she worked there or did this job",
    "job-description": "🎯 A ROLE SHE WAS INTERESTED IN — a posting she saved/applied to; "
                       "a target, NOT a job she held",
